...
public class PropertyFileUserStorageProvider implements
    ...
    public UserModel getUserById(String id, RealmModel realm) {
        logger.warn("getUserById(String id, RealmModel realm)");
        logger.warn("id : " + id);
    ...
    public List<UserModel> getUsers(RealmModel realm) {
        logger.warn("getUsers(RealmModel realm)");
        logger.warn("realm : " + realm);
    ...
    public List<UserModel> getUsers(RealmModel realm, int firstResult, int maxResults) {
        logger.warn("getUsers(RealmModel realm, int firstResult, int maxResults)");
        logger.warn("realm : " + realm);
    ...
    public List<UserModel> searchForUser(String search, RealmModel realm, int firstResult, int maxResults) {
        logger.warn("searchForUser(String search, RealmModel realm, int firstResult, int maxResults)");
        logger.warn("search : " + search);
        logger.warn("realm : " + realm);
    ...
    public List<UserModel> searchForUser(Map<String, String> params, RealmModel realm, int firstResult, int maxResults) {
        ...
        logger.warn("searchForUser(Map<String, String> params, RealmModel realm, int firstResult, int maxResults)");
...
//        return searchForUser(usernameSearchString, realm, firstResult, maxResults);
    ...
    public List<UserModel> getGroupMembers(RealmModel realm, GroupModel group, int firstResult, int maxResults) {
        ...
        logger.warn("getGroupMembers(RealmModel realm, GroupModel group, int firstResult, int maxResults)");
    ...
    public List<UserModel> getGroupMembers(RealmModel realm, GroupModel group) {
        ...
        logger.warn("getGroupMembers(RealmModel realm, GroupModel group)");
    ...
    public List<UserModel> searchForUserByUserAttribute(String attrName, String attrValue, RealmModel realm) {
        ...
        logger.warn("searchForUserByUserAttribute(String attrName, String attrValue, RealmModel realm)");
